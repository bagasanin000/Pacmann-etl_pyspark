...
CREATE UNIQUE INDEX IF NOT EXISTS idx_object_id 
...
CREATE TABLE IF NOT EXISTS fact_investments (
    ...
    CONSTRAINT fk_funded FOREIGN KEY (funded_object_id) REFERENCES dim_company(company_id),
    CONSTRAINT fk_investor_company FOREIGN KEY (investor_object_id) REFERENCES dim_company(company_id) DEFERRABLE INITIALLY DEFERRED,
    CONSTRAINT fk_investor_person FOREIGN KEY (investor_object_id) REFERENCES dim_people(people_id) DEFERRABLE INITIALLY DEFERRED
);
...
CREATE TABLE IF NOT EXISTS dim_funding_rounds (
    ...
    -- Foreign Key Constraints
	CONSTRAINT fk_funding_company FOREIGN KEY (funding_object_id) REFERENCES dim_company(company_id) DEFERRABLE INITIALLY DEFERRED,
	CONSTRAINT fk_funding_people FOREIGN KEY (funding_object_id) REFERENCES dim_people(people_id) DEFERRABLE INITIALLY DEFERRED
...
CREATE TABLE IF NOT EXISTS fact_relationship (
    ...
    -- Foreign Key Constraints
    CONSTRAINT fk_relationship_people FOREIGN KEY (people_object_id) REFERENCES dim_people(people_id),
    CONSTRAINT fk_relationship_company FOREIGN KEY (relationship_object_id) REFERENCES dim_company(company_id)
);
...
CREATE TABLE IF NOT EXISTS fact_ipo (
    ...
    -- Foreign Key Constraints
	CONSTRAINT fk_ipo_company FOREIGN KEY (ipo_object_id) REFERENCES dim_company(company_id) DEFERRABLE INITIALLY DEFERRED,
	CONSTRAINT fk_ipo_people FOREIGN KEY (ipo_object_id) REFERENCES dim_people(people_id) DEFERRABLE INITIALLY DEFERRED
);
...
CREATE TABLE IF NOT EXISTS dim_funds (
    ...
    -- Foreign Key Constraints
	CONSTRAINT fk_fund_company FOREIGN KEY (fund_object_id) REFERENCES dim_company(company_id) DEFERRABLE INITIALLY DEFERRED,
	CONSTRAINT fk_fund_people FOREIGN KEY (fund_object_id) REFERENCES dim_people(people_id) DEFERRABLE INITIALLY DEFERRED
